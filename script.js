...
function convertValues() {
    ...
    const dolarToday = 4.92 // Valor ficticio
    const euroToday = 5.37 // Valor ficticio
    const libraToday = 6.23 // Valor ficticio
    const bitcoinToday = 186990.58 // Valor ficticio
